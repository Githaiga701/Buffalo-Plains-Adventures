          ...
          >
            <div>
              ...
              <div className="space-y-5">
                <a href="mailto:buffaloplainsadventuresltd@gmail.com" className="flex items-center gap-4 text-muted-foreground hover:text-secondary transition-colors">
                  <div className="w-12 h-12 rounded-full bg-muted flex items-center justify-center"><Mail size={20} /></div>
                  <div><p className="text-sm font-medium text-foreground">Email</p><p className="text-sm">buffaloplainsadventuresltd@gmail.com</p></div>
                </a>
