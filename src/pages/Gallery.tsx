...
const galleryImages = [
  { src: masaiMara, alt: "Wildebeest Migration in Masai Mara", caption: "The Great Migration" },
  { src: amboseli, alt: "Elephants at Amboseli", caption: "Amboseli Elephants" },
  { src: dianiBeach, alt: "Diani Beach Kenya", caption: "Diani Beach" },
  { src: tsavo, alt: "Lions in Tsavo", caption: "Tsavo Lions" },
  { src: lamu, alt: "Lamu Old Town", caption: "Lamu Heritage" },
  { src: luxurySafari, alt: "Luxury Safari Lodge", caption: "Luxury Lodges" },
  { src: safariSunset, alt: "Safari Sunset", caption: "African Sunset" },
  { src: masaiMaraDest, alt: "Masai Mara Sunset", caption: "Masai Mara" },
];
